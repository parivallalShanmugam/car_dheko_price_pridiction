...
# with col2:
#     owner_no = st.number_input('Owner Number', min_value=1, max_value=5)
#     car_model = st.selectbox('Car Model', df['model'].unique())
#     model_year = st.number_input('Model Year', min_value=int(df['modelyear'].min()), max_value=int(df['modelyear'].max()))
